...
const Loader = ({ duration, onLoadingComplete }) => {
      ...
      setProgress((prevProgress) => {
        if (prevProgress >= 100) {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => onLoadingComplete(), 500) // 500ms for fade-out duration
          }, 5000) // 1000ms delay before starting fade-out
  ...
  return (
    <div ref={loaderRef} className="h-full w-full flex items-center justify-center">
      <div className="loader w-full h-[40vh] flex-grow-0 flex flex-col items-center justify-center gap-8 relative">
        
        <div ref={titleRef} className="h-1/5 flex items-center">
        ...
        <div className="relative w-full h-3/5 flex justify-center items-center">
          <div ref={spinnerRef} className={`spinner w-[168px] h-[124px] absolute z-40`}></div>

          <div ref={logoRef} className="logo opacity-0 w-[168px] h-[124px] flex flex-col items-center select-none cursor-pointer absolute z-50">
            <span
